/**
 * Copyright C, 2016-2018, Huawei Tech.Co.,Ltd.
 *
 * @Author niuyanbin nwx305700
 * @Date: 2016-05-03
 * @Description: 自定义可拖动Item排序ListView
 * @Others:
 */
...
import com.huawei.ui.commonui.utils.ViewUtils;
...
public class DragListAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (BuildConfig.IS_21_VERSION) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.activity_device_settings_contact_orderby_item_layout_black, null);
        } else {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.activity_device_settings_contact_orderby_item_layout, null);
        }
        ...
        numberTv.setText(contactTable.getPhoneNumbers().get(0).getPhone_number());
